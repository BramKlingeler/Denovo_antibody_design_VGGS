...
#from ggs.constant._tokens import ALPHABET_AHO
...
ALPHABET = list("ARNDCQEGHILKMFPSTWYV-") # = ALPHABET_AHO #Redefine for gap tokens
...
def main(cfg: DictConfig) -> Optional[float]:
    ...
    predictor_info = torch.load(predictor_path, map_location='cuda:0') #, weights_only=True
